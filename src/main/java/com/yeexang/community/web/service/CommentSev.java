...
public class CommentSev extends BaseSev<Comment, String> {
            ...
            if (optional.isPresent()) {
                ...
                if (comment != null) {
                    ...
                    if (CommonField.FIRST_LEVEL_COMMENT.equals(comment.getCommentType())) {
                        ...
                        // 发送回帖消息通知
                        threadUtil.execute(new SendNotificationTask(account, topicId, commentId, NotificationField.TOPIC_VALUE));
                        ...
                        // 发送回复评论消息通知
                        threadUtil.execute(new SendNotificationTask(account, parent.getCommentId(), commentId, NotificationField.COMMENT_VALUE));
                    }
